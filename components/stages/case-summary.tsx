        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold">{Math.round(((vehicleData.currentStage || 1) / 7) * 100)}%</p>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-lg font-bold">{formatDate(vehicleData.createdAt)}</p>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-lg font-bold">{formatDate(vehicleData.updatedAt)}</p>
            ...
            <div className="space-y-2">
              ...
              {vehicleData.vehicle?.knownDefects && (
                <div className="p-3 bg-red-50 rounded-lg border border-red-200">
                  <p className="text-sm font-medium text-red-800 mb-1">Known Defects:</p>
                  <p className="text-sm text-red-700">{vehicleData.vehicle.knownDefects}</p>
                </div>
              )}
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-blue-50 rounded-lg">
              <div className="text-center">
                <p className="text-2xl font-bold text-blue-600">{vehicleData.inspection.overallRating || 0}/5</p>
                <p className="text-sm text-blue-800">Overall Rating</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-green-600">
                  {vehicleData.inspection.overallScore || 0}/{vehicleData.inspection.maxPossibleScore || 0}
                </p>
                <p className="text-sm text-green-800">Total Score</p>
              </div>
              <div className="text-center">
                <p className="text-2xl font-bold text-purple-600">{vehicleData.inspection.sections.length}</p>
                <p className="text-sm text-purple-800">Sections Completed</p>
              </div>
            </div>
            ...
            {vehicleData.inspection.inspectionNotes && (
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                <h4 className="font-medium text-blue-800 mb-2">Inspection Notes</h4>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-4 bg-green-50 rounded-lg border border-green-200">
              <div className="text-center">
                ...
                <p className="text-sm text-green-800">Final Sale Price</p>
              </div>
            </div>
            ...
            {vehicleData.vehicle?.estimatedValue && (
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                <div className="text-center">
                  ...
                  <p className="text-sm text-blue-800">Estimated Value</p>
                </div>
              </div>
            )}
            ...
            {vehicleData.quote?.offerAmount && (
              <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                <div className="text-center">
                  ...
                  <p className="text-sm text-purple-800">Initial Offer</p>
                </div>
              </div>
            )}
            ...
            {vehicleData.offerDecision?.counterOffer && (
              <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                <div className="text-center">
                  ...
                  <p className="text-sm text-orange-800">Counter Offer</p>
                </div>
              </div>
            )}
          </div>
          ...
          {vehicleData.inspection?.safetyIssues && vehicleData.inspection.safetyIssues.length > 0 && (
            <div className="mt-6 p-4 bg-red-50 rounded-lg border border-red-200">
              <h4 className="font-medium text-red-800 mb-3">Safety Issues Cost Analysis</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
          ...
          {vehicleData.inspection?.maintenanceItems && vehicleData.inspection.maintenanceItems.length > 0 && (
            <div className="mt-4 p-4 bg-orange-50 rounded-lg border border-orange-200">
              <h4 className="font-medium text-orange-800 mb-3">Maintenance Cost Analysis</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
